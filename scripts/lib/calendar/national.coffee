...
initNationalCalendars = (callback) ->
  ...
  load = (natId) ->
    url = "https://www.google.com/calendar/ical/en.#{id}%23holiday%40group.v.calendar.google.com/public/basic.ics"
    ical.fromURL url, {}, (err, data) ->
      if err
        console.log "A error occurs when get national calendar #{id} #{errReq}"
      else
