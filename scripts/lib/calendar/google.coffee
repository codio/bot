...
TOKEN_DIR = path.dirname(process.env.HUBOT_CALENDAR_CREDENTIALS_PATH)
TOKEN_PATH = process.env.HUBOT_CALENDAR_CREDENTIALS_PATH
...
init = (callback) ->
  key_file = process.env.HUBOT_CALENDAR_GOOGLE_KEY_PATH
